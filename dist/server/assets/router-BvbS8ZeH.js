...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Muhammad Musammil" },
      { name: "theme-color", content: "#08080F" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Musammil Dev" },
    ...
    links: [
      ...
      { rel: "icon", href: "/profile.webp", type: "image/webp" }
    ]
  }),
  ...
  head: () => ({
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        url: "/",
        sameAs: ["https://github.com/musammilvilayil", "https://www.linkedin.com/in/muhammad-musammil-a-646882280/"]
      })
    }]
  }),
