...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DNaJCv_O.js");
...
const manifest = {
  "1ac20e83585a55e943670fa4670b07889b610801a7a21f28dc367c19f92e50fd": {
    ...
    importer: () => import("./contact.functions-B4Ll9aq_.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DmR3qSI2.js"),
    import("./start-tQw4mcK_.js"),
